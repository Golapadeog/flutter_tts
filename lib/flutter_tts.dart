...
class FlutterTts {
  ...
  /// [Future] prompt the user to install TTS data
  /// ***Android supported only ***
  Future<dynamic> installLanguage(String language) => _channel.invokeMethod('installLanguage', <String, Object>{'language': language});
